...
class ErrorDetails(BaseErrorDetails):
    ...
    TENANT_ALREADY_EXISTS: str = "User with provided credentials already exists"
    TENANT_NOT_FOUND: str = "User with provided credentials not found"
    TENANT_ATTRIBUTE_REQUIRED: str = "user id, email or username is required"
    TENANT_CAN_NOT_VOTE_FOR_HIMSELF: str = "User can not vote for himself"
    TENANT_STATISTICS_NOT_FOUND: str = "User statistics not found"
    TENANT_ALREADY_VOTED: str = "Current user already voted for provided user"

    LICENSE_ALREADY_EXISTS: str = "User with provided credentials already exists"
    LICENSE_NOT_FOUND: str = "User with provided credentials not found"
    LICENSE_ATTRIBUTE_REQUIRED: str = "user id, email or username is required"
    LICENSE_CAN_NOT_VOTE_FOR_HIMSELF: str = "User can not vote for himself"
